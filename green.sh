...
wget -q -O slowdns.sh https://raw.githubusercontent.com/arismaramar/ssset/master/SLDNS/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
...
curl "https://raw.githubusercontent.com/arismaramar/ssset/master/ipsec/ipsec.sh" | bash
